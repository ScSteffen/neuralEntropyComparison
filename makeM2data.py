...
datafile = 'M2'+mode+'Data'+saveid

tablefile = 'M2' + mode + 'DataTable'+saveid
...
if savedata == True:
    with open(datafile + '.pickle','wb') as filehandle:
        pickle.dump(datalist,filehandle)
    with open(tablefile + '.pickle','wb') as tablehandle:
        pickle.dump(Data_Table,tablehandle)
